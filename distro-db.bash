...
if [[ -n "$IntranetBaseUrl" ]]; then
	distroInfo[FreeBSD-13.0]="$IntranetBaseUrl/vm-images/FreeBSD-13.0/FreeBSD-13.0-RELEASE-amd64.qcow2.xz"
	distroInfo[FreeBSD-12.2]="$IntranetBaseUrl/vm-images/FreeBSD-12.2/FreeBSD-12.2-RELEASE-amd64.qcow2.xz"
